...
const Hero = () => {
  ...
  return (
    <>
      ...
      <section
        id="home"
        className="relative w-full h-[80vh] md:h-[90vh] flex items-center pt-20 md:pt-0 bg-black"
      >
        {/* Desktop Background */}
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl md:text-2xl text-primary-foreground/90 mb-8 max-w-2xl"></p>
